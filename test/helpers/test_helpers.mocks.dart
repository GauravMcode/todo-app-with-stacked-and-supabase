...
// in todo_stacked/test/helpers/test_helpers.dart.
...
import 'package:todo_stacked/models/task.dart' as _i10;
import 'package:todo_stacked/services/supabase_service.dart' as _i9;
...
class MockSupabaseService extends _i1.Mock implements _i9.SupabaseService {
  ...
  @override
  _i7.Future<List<_i10.Task>> getAllTasks() => (super.noSuchMethod(
        Invocation.method(
          #getAllTasks,
          [],
        ),
        returnValue: _i7.Future<List<_i10.Task>>.value(<_i10.Task>[]),
        returnValueForMissingStub:
            _i7.Future<List<_i10.Task>>.value(<_i10.Task>[]),
      ) as _i7.Future<List<_i10.Task>>);

  @override
  dynamic addTask(_i10.Task? task) => super.noSuchMethod(
        Invocation.method(
          #addTask,
          [task],
        ),
  ...
  @override
  dynamic editTask(_i10.Task? task) => super.noSuchMethod(
        Invocation.method(
          #editTask,
          [task],
        ),
  ...
  @override
  dynamic deleteTask(int? id) => super.noSuchMethod(
        Invocation.method(
          #deleteTask,
          [id],
        ),
